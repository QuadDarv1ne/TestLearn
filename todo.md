...
### 2.3.14 (05.05.2026)
- **Обновлена версия проекта** до 2.3.14 в todo.md для соответствия main.py
- **Подготовка к релизу**: все изменения в dev ветке готовы к слиянию в main после тестирования
