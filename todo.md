...
## ✅ Завершённые функции (по состоянию на 02.05.2026)
...
- [x] **85 тестов API** с 100% проходимостью (59 API + 19 QuizCheckerService + 7 CertificateService)
...
|---------|----------|
| Версия | 2.3.6 |
| Тесты | 85/85 (100%) |`n| Ветка dev | ✅ Создана |
...
### 2.3.8 (02.05.2026)`n- **Добавлены интеграционные тесты** для auth registration (4 новых теста)`n- **Заменён алгоритм хеширования** с bcrypt на SHA-256 с солью`n- **Исправлен deprecation warning** datetime.utcnow()`n- **89 тестов API** с 100% проходимостью`n`n### 2.3.7 (02.05.2026)`n- **Устранён deprecation warning** в Jinja2Templates (убран auto_reload)`n- **85 тестов API** с 100% проходимостью`n`n### 2.3.6 (02.05.2026)`n- **Создана ветка dev** для разработки по принципу dev тЭФ main`n- **85 тестов API** с 100% проходимостью`n`n### 2.3.3 (01.05.2026)
...
- **Обновлён `.gitignore`** — добавлены `data/` и `logs/`
- **59 тестов API** с 100% проходимостью
