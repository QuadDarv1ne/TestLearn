...
### 2.3.7 (02.05.2026)`n- **Устранён deprecation warning** в Jinja2Templates (убран auto_reload)`n- **85 тестов API** с 100% проходимостью`n`n### 2.3.6 (02.05.2026)`n- **Создана ветка dev** для разработки по принципу dev тЭФ main`n- **85 тестов API** с 100% проходимостью`n`n### 2.3.3 (01.05.2026)
