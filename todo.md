...
- [x] **Доработать документацию** ✅
  ...
  - API changelog — реализовано (docs/API_CHANGELOG.md)
...
3. [ ] **Исправить CSRF middleware тесты** — 3 failing теста
...
|---------|----------|
| Версия | 2.3.14 |
| Тесты | 101/104 (97%) — 3 failing (CSRF middleware) |
| Ветка dev | ✅ Создана |
| Готовность к демо | ✅ Да |
| Готовность к продакшену | ⚠️ Требует исправления 3 тестов |
...
### 2.3.14 (06.05.2026)
- **Обновлён todo.md** — добавлены failing тесты CSRF middleware (3 шт)
- **Тесты**: 101/104 passing (97%)
- **Известная проблема**: CSRF middleware тесты требуют исправления
